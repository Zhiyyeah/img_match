...
# -*- coding: utf-8 -*-
"""
Landsat 角度影像可视化（SZA/SAA/VZA/VAA）——精简版
...
def parse_mtl(mtl_path):
    ...
    pats = {
        "SZA": r'FILE_NAME_ANGLE_SOLAR_ZENITH_BAND_4\s*=\s*"?([A-Za-z0-9_\-\.]+)"?',
        "SAA": r'FILE_NAME_ANGLE_SOLAR_AZIMUTH_BAND_4\s*=\s*"?([A-Za-z0-9_\-\.]+)"?',
...
if __name__ == "__main__":
    if not MTL_PATH.exists():
        ...
        exit(1)
    angle_files = parse_mtl(MTL_PATH)
    print("角度文件:")
